#!/usr/bin/env python
"""
Script to do some crazy ass dynamic inventory stuff without hurting myself
"""
...
ANSIBLE_INV = {
    "all": {
        "vars": {
            ...
            "ansible_python_interpreter": "/home/leomiller/VENV/ansible/bin/python",
    ...
    "juniper": {
      "hosts": ["vmx1", "vmx2"],
      "var": {"ansible_network_os": "junos",
              "ansible_connection": "netconf"},
    },
    "nxos": {
      "hosts": ["nxos1", "nxos2"],
      "var": {"ansible_network_os": "nxos"},
    }
}
